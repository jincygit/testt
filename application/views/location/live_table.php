...
$(document).ready(function(){
  ...
  {
    $.ajax({
      url:"<?php echo base_url(); ?>index.php/live/load_data",
      dataType:"JSON",
  ...
  $(document).on('click', '#btn_add', function(){
    ...
    $.ajax({
      url:"<?php echo base_url(); ?>index.php/live/insert",
      method:"POST",
  ...
  $(document).on('blur', '.table_data', function(){
    ...
    var value = $(this).text();
    $.ajax({
      url:"<?php echo base_url(); ?>index.php/live/update",
      method:"POST",
  ...
  $(document).on('click', '.btn_delete', function(){
    ...
    {
      $.ajax({
        url:"<?php echo base_url(); ?>index.php/live/delete",
        method:"POST",
        data:{id:id},
        success:function(data){
          load_data();
